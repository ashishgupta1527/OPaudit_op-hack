...
const start = () => {
  return (
    <>
      <div className="max-w-3xl mx-auto p-4 border-2 rounded-md flex justify-between my-8">
        ...
        <div className="space-y-4">
          <p className="max-w-96">
            0xFable is a fully on-chain trading card game, in the spirit of Magic the Gathering and
            Hearthstone.
          </p>
          <button
            type="button"
